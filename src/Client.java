        ...
        try {
            ...
            while(1 == 1){
                ...
                if(cmd == '1'){
                    ...
                    Minimax minimax = new Minimax(racine);
                    String nextMove = minimax.trouverDeplacement(jeu, racine, PROFONDEUR, jeu.getMaCouleur());
                ...
                if(cmd == '2'){
                    //intln("Nouvelle partie! Vous jouer noir, attendez le coup des blancs");
                    byte[] aBuffer = new byte[1024];
